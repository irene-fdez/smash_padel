                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label" for="input-email">Nombre Funcionalidad</label>
                                <input type="text" name="nombre" required value="<?php if($this->edit) { echo $this->data['nombre']; } ?>" class="form-control form-control-alternative">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                <label class="form-control-label" for="input-username">Descripcion Funcionalidad</label>
                                <input type="text" name="descripcion" required value="<?php if($this->edit) { echo $this->data['descripcion']; } ?>" class="form-control form-control-alternative" >
                            </div>
                        </div>
