        ...
        <?php new Header(); ?>            
                    <div class="card shadow">
                        ...
                        <div class="card-header bg-secondary border-0">
                            ...
                            <h6 class="heading-small text-muted mb-4" style="height: 10px">Selecciona el horario para el que quieres hacer la reserva</h6>
                        </div>
								...
								?>
                                    ...
                                    ?>     
                                        ...
                                        <?php  }elseif( $this->pistas_disponibles  == 1 ) { ?>
                                            ...
                                            <a href="../Controllers/<?=$_SESSION['currentController']?>_Controller.php?action=SHOW_PISTAS&fecha=<?=$this->dias_semana[$i][1]?>&id_horario=<?=$key?>">
                                        ...
                                        <!--a href="../Controllers/<?=$_SESSION['currentController']?>_Controller.php?action=SHOW_PISTAS&fecha=<?=$this->dias_semana[$i][1]?>&id_horario=<?=$key?>" class="button small"><?=$value?></a-->
