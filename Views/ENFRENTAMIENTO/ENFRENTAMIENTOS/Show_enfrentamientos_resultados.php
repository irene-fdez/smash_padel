...
class Show_enfrentamientos_resultados
{
                            ...
                            <div class="card-header bg-secondary border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-right">
                                        <a href="../Controllers/<?php echo $_SESSION['currentController']?>_Controller.php?action=SHOW_ENFRENTA&campeonato_id=<?=$this->campeonato_id?>&add_result=true"
                                            ...
                                            foreach ($this->fase_grupos as $key => $value){ ?>
                                                <tr style="height: 50px;">
                                                    ...
                                                    <?php if( $value['resultado'] == NULL){ ?>
                                                        <td style="color:#fb6340;"> No hay resultados </td>
                                                        <td class="text-right" style="width:15%;">
                                                            <a href="../Controllers/ENFRENTAMIENTO_Controller.php?action=ADD_RESULTADOS&id=<?=$value['enfrentamiento_id']?>">
