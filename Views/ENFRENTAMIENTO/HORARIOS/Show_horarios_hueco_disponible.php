...
class Show_horarios_hueco_disponible{
    ...
    function __construct($horarios, $reservas, $pistas, $enfrentamiento_id, $pareja_id){
        ...
        <?php new Header(); ?>            
                    <div class="card shadow">
                        ...
                        <div class="card-header bg-secondary border-0">
                            ...
                            <h6 class="heading-small text-muted mb-4" style="height: 10px">Selecciona un horario para disputar el enfrentamiento</h6>
                        </div>
								...
								?>
                                    ...
                                    ?>     
                                        ...
                                        <?php  }elseif( $this->pistas_disponibles  == 1 ) { ?>
                                            ...
                                            <a href="../Controllers/HUECO_DISPONIBLE_Controller.php?action=ADD_HUECO&fecha=<?=$this->dias_semana[$i][1]?>&horario_id=<?=$key?>&enfrentamiento_id=<?=$this->enfrentamiento_id?>&pareja_id=<?=$this->pareja_id?>">
                                        ...
                                        <!--a href="../Controllers/<?=$_SESSION['currentController']?>_Controller.php?action=ADD_HUECO&fecha=<?=$this->dias_semana[$i][1]?>&horario=<?=$key?>&enfrentamiento_id=<?=$this->enfrentamiento_id?>&pareja_id=<?=$this->pareja_id?>" class="button small"><?=$value?></a-->
