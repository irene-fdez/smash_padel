                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-header bg-secondary border-0">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="mb-0">Huecos ofertados (<?= $this->data['nombre_campeonato'] ?>)</h3>
                                    </div>
                                    <div class="col text-right">
                                        <a href="../Controllers/HUECO_DISPONIBLE_Controller.php?action=RECHAZAR_PROPUESTA&opcion=propuestas&enfrentamiento_id=<?=$this->enfrentamiento_id?>&pareja_id=<?=$this->pareja_id?>" class="btn btn-sm btn-primary">Rechazar y proponer nueva</a>
                                    </div>
                                </div>
                                <h6 class="heading-small text-muted mb-4" style="height: 10px">
                                    Disponibilidad de tus openetes (
                                            <b><span style="text-transform: capitalize;"><?= $this->data['capitan']?></span> 
                                            <span style="text-transform: initial;"> y </span> 
                                            <span style="text-transform: capitalize;"><?= $this->data['jugador_2'] ?></span></b>
                                    ) para disputar el enfrentamiento
                                </h6>
                            </div>
                            ...
                            <hr class="my-4">
                            <a href="../Controllers/ENFRENTAMIENTO_Controller.php?action=GESTION_HORARIO">
